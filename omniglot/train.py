...
from model1 import PrototypicalNetwork, PrototypicalNetwork_new
from utils import get_accuracy_proto, get_accuracy_anil
...
def train(args):
    ...
    model_full = PrototypicalNetwork_new(1,
                                args.embedding_size,
                                args.num_ways,
                                hidden_size=args.hidden_size)
    ...
    if args.output_folder is not None:
        filename1 = os.path.join(args.output_folder, 'protonet_full_omniglot_'
            '{0}shot_{1}way.pt'.format(args.num_shots, args.num_ways))
        filename2 = os.path.join(args.output_folder, 'protonet_enc_omniglot_'
            '{0}shot_{1}way.pt'.format(args.num_shots, args.num_ways))
